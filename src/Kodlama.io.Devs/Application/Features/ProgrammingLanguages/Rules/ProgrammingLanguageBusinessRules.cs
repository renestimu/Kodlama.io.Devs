...
namespace Application.Features.ProgrammingLanguages.Rules
{
    public class ProgrammingLanguageBusinessRules
    {
        ...
        public async Task ProgrammingLanguageShouldExistWhenRequested(ProgrammingLanguage result)
        {
            // Brand result = await _brandRepository.GetAsync(b => b.Id == id);
            if (result == null) throw new BusinessException("Request Programming language does not exist.");
        }
    }
}
